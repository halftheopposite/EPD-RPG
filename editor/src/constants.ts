...
export const STORAGE_KEYS = {
  EDITOR_STATE: "epd-rpg-tilemap-editor",
  SPRITESHEET: "epd-rpg-tilemap-editor-spritesheet",
  SPRITESHEET_DATA: "epd-rpg-tilemap-editor-spritesheet-data",
  SIDEBAR_WIDTH: "epd-rpg-tilemap-editor-sidebar-width",
  SPRITE_SCALE: "epd-rpg-tilemap-editor-sprite-scale",
};
